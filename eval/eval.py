...
#     # ==========================================
#     # 3. Compute RadGraph F1
#     # ==========================================
#     print("\n[2/3] Computing RadGraph...")
#     # reward_level="partial" is standard for RadGraph. It gives credit for overlapping
#     # entities and relations even if they aren't a 100% perfect match.
...
#     # ==========================================
#     # 5. Save Results Back to CSV
#     # ==========================================
#     print("\nSaving granular metrics back to CSV...")
#     df["bertscore_f1"] = F1_bert.numpy()
#     df["radgraph_f1"] = rg_score_list
#     df["green_score"] = green_score_list
